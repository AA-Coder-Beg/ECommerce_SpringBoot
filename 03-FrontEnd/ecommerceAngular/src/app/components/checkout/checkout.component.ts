...
export class CheckoutComponent implements OnInit {
  ...
  copyShippingAddressToBillingAddress(event: any) {
    if (event.target.checked) {
      ...
      this.billingAddressStates = this.shippingAddressStates; //bug fix 
    }
    else {
  ...
  onSubmit() {
    ...
    console.log("The shipping address state is " + this.checkoutFormGroup.get('shippingAddress')!.value.states.name);
  }
}
